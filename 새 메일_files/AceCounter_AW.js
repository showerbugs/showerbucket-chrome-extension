...
var _TOAST=(function(u){var si=new Image(0,0),dv='ACEUCI=1',dc=document;if(String(document.cookie).indexOf('ACEUCI')==-1){si.src=location.protocol+'//adlc-exchange.toast.com/sendid?sid=acecounter&uid='+u+'&rnd='+Math.random();};dc.cookie=dv+';';return si;})('1423271269119647794');
