...
(function() {
    ...
    // create 소스 수정
    i18n.create = function(data, lang) {
        var trans;

        trans = i18n[lang] ? i18n[lang].translator : new Translator();
        if (data != null) {
            trans.add(data);
        }
        trans.translate.create = i18n.create;
        if (!i18n[lang] && lang) {
            i18n[lang] = trans.translate;
            i18n[lang].translator = trans;
        }
        return trans.translate;
    };


    ((typeof exports == "object" && typeof module == "object") ? module.exports = i18n : void 0) || (this.i18n = i18n);
