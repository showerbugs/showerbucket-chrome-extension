...
// Make multiple matches sortable
  uis.directive('uiSelectSort', ['$timeout', 'uiSelectConfig', 'uiSelectMinErr', function($timeout, uiSelectConfig, uiSelectMinErr) {
    ...
    // Make multiple matches sortable
    uis.directive('uiSelectMoveable', ['$timeout', 'uiSelectConfig', 'uiSelectMinErr', function($timeout, uiSelectConfig, uiSelectMinErr) {
        return {
            require: 'uiSelect',
            link: function(scope, element, attrs, $select) {
                console.log(scope, element, attrs, $select)
                ...
                console.log(element.find('.ui-select-match-item'))
                ...
                element.on('dragstart', function(event) {
                    ...
                    //targetScope.$select.selected.splice(targetScope.$index, 1);
                    //$timeout(function() {
                    //    scope.$selectMultiple.updateModel();
                    //
                    //}, 20, false);
