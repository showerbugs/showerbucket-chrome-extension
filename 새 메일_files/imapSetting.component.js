(function () {
    ...
    angular
        ...
        .component('imapSetting', {
            templateUrl: 'modules/setting/user/imapSetting/imapSetting.html',
            controller: ImapSetting
        });

    /* @ngInject */
    function ImapSetting(API_PAGE_SIZE, MemberMeEmailAddresses, MemberTokenRepository, MessageModalFactory, MyInfo, gettextCatalog, _) {
        var $ctrl = this,
        ...
        function _init() {
            ...
            MemberMeEmailAddresses.fetchList({size: API_PAGE_SIZE.ALL}).then(function (result) {
                $ctrl.imapId = _.get(_.find(result.contents(), {'default': true}), 'emailAddress');
            });
        }
